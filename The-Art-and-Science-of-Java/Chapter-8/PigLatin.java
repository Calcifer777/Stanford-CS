...
public class PigLatin extends ConsoleProgram {
	...
	/* Translates the word to pig latin and returns the translated word*/
	...
	/* Return the index of the first vower in the word (-1 if none) */
	...
	/* Returns true if the token is a word ( all the characters are letters) */
